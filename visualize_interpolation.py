...
def get_args_parser():
    parser = argparse.ArgumentParser('Visualize MAE video completions', add_help=False)
    ...
    parser.add_argument('--mask_type', default='center', type=str, help='Mask type', choices=['random', 'temporal', 'center'])
...
if __name__ == '__main__':
    ...
    for v in selected_files:
        vid = prepare_video(v)
        vid.to(device)  # move input to device
